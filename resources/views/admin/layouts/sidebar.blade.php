<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Danh mục</span></a>
                <ul class="dropdown-menu">
                    <li><a href="{{ route('admin.category.create') }}" href="nav-link">Tạo</a></li>
                    <li><a class="nav-link" href="{{ route('admin.category.index') }}">Danh sách</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Sản phẩm</span></a>
                <ul class="dropdown-menu">
                    <li><a href="{{ route('admin.product.create') }}" href="nav-link">Tạo</a></li>
                    <li><a class="nav-link" href="{{ route('admin.product.index') }}">Danh sách</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Đơn hàng</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.orders.index') }}">Danh sách</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Mã giảm giá</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.coupon.create') }}">Tạo</a></li>
                    <li><a class="nav-link" href="{{ route('admin.coupon.index') }}">Danh sách</a></li>
                </ul>
            </li>
            ...
            <li><a href="#" class="nav-link"><i class="fas fa-exclamation"></i>
